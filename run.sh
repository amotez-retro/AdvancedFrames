...
ffmpeg -i "$1" -nostdin -ss 00:00:00 -to 00:30:00 -r 10/1 -vf scale=240:160,setsar=1:1 -q:v 2 working/frames/output%03d.bmp
...
ffmpeg -i "$1" -nostdin -y -ss 00:00:00 -to 00:30:00 -acodec pcm_s8 -ac 1 -ar 8000 -f s8 working/audio.raw

# Create sound header with raw2gba
echo "Convert pcm audio to header"
./working/raw2gba ./working/audio.raw
